...
export default async function Home() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10 sm:py-16">
      ...
      <MySplits server={mine} loggedIn={!!user} />
      ...
      <footer className="mt-16 flex flex-col items-center gap-4 text-center text-xs text-stone-400">
        ...
        {/* Builder-facing links. "MCP" is the same acronym in all six locales,
            so it needs no dictionary entry; the page it opens explains it. */}
