...
const is: Dict = {
  ...
  passkeys: {
    title: "Aðgangslyklar",
    intro:
      "Með aðgangslykli skráir þú þig inn með fingrafari, andliti eða skjálás — án þess að bíða eftir tölvupósti. Þú getur alltaf skráð þig inn með kóða í tölvupósti.",
    loading: "Sæki…",
    empty: "Þú ert ekki með aðgangslykil enn.",
    unnamed: "Aðgangslykill",
    added: "bætt við {date}",
