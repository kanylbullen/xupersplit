...
const sv = {
  ...
  passkeys: {
    title: "Passkeys",
    intro:
      "Med en passkey loggar du in med fingeravtryck, ansikte eller skärmlås — utan att vänta på ett mejl. Du kan alltid logga in med e-postkod ändå.",
    loading: "Hämtar…",
    empty: "Du har ingen passkey ännu.",
    unnamed: "Passkey",
    added: "tillagd {date}",
  ...
  landing: {
    ...
    aiPill: "Fungerar med Claude, ChatGPT och fler",
  ...
  footer: {
    ...
    feedback: "något trasigt?",
    terms: "villkor",
    privacy: "integritetspolicy",
    cookies: "cookies",
    help: "hjälp",
    madeWith: "gjord med",
    createOwn: "skapa en egen",
  ...
  new: {
    ...
    typeHeading: "Vad för slags split?",
    typeSimple: "Enkel",
    typeSimpleDesc: "Ingen inloggning — bara namn och en länk.",
    typeEmail: "E-post",
    typeEmailDesc: "Bjud in varje person via e-post.",
    typeFarcaster: "Farcaster",
    typeFarcasterDesc: "Välj personer du följer på Farcaster.",
    signInRequired: "kräver inloggning",
    back: "Tillbaka",
    toHome: "Hem",
    emailInviteHint: "Varje person bjuds in via e-post och tar sin egen plats.",
    ...
    claimInvite: "Bjud in specifika personer",
    requireFarcaster: "Kräv Farcaster-inloggning",
    requireFarcasterHint: "Alla går med via sitt Farcaster-konto — välj din plats inifrån Farcaster.",
    inviteEmailPlaceholder: "e-post till deltagaren",
    inviteHandlePlaceholder: "e-post eller @farcaster",
    fcInviteHint: "Skriv e-post eller @Farcaster-namn — eller tryck 👥 (i Farcaster-appen) för att välja bland dina följда.",
  ...
  claim: {
    ...
    farcasterOnly: "Den här spliten är för Farcaster-konton — öppna den i Farcaster för att gå med.",
  },
  login: {
    title: "Logga in",
    subtitle:
  ...
  errors: {
    ...
    farcaster_required: "Den här spliten kräver ett Farcaster-konto — öppna den i Farcaster.",
