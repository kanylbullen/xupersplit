...
const en: Dict = {
  ...
  passkeys: {
    title: "Passkeys",
    intro:
      "A passkey signs you in with your fingerprint, face or screen lock — no waiting for an email. You can always fall back to an email code.",
    loading: "Loading…",
    empty: "You don't have a passkey yet.",
    unnamed: "Passkey",
    added: "added {date}",
  ...
  landing: {
    ...
    aiPill: "Works with Claude, ChatGPT and more",
