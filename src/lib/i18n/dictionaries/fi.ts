...
const fi: Dict = {
  ...
  passkeys: {
    ...
    intro:
      "Passkeyllä kirjaudut sisään sormenjäljellä, kasvoilla tai näytön lukituksella — sähköpostia odottamatta. Voit aina kirjautua myös sähköpostikoodilla.",
    loading: "Haetaan…",
    empty: "Sinulla ei ole vielä passkeytä.",
    unnamed: "Passkey",
    added: "lisätty {date}",
  ...
  landing: {
    ...
    aiPill: "Toimii Clauden ja ChatGPT:n kanssa",
  ...
  new: {
    ...
    typeHeading: "Millainen jako?",
    typeSimple: "Yksinkertainen",
    typeSimpleDesc: "Ei kirjautumista — vain nimet ja linkki.",
    typeEmail: "Sähköposti",
    typeEmailDesc: "Kutsu jokainen sähköpostitse.",
    typeFarcaster: "Farcaster",
    typeFarcasterDesc: "Valitse seuraamiasi Farcasterissa.",
    signInRequired: "vaatii kirjautumisen",
    back: "Takaisin",
    toHome: "Etusivu",
    emailInviteHint: "Jokainen kutsutaan sähköpostitse ja varaa oman paikkansa.",
    ...
    requireFarcasterHint: "Kaikki liittyvät Farcaster-tilillään — valitse paikka Farcasterissa.",
  ...
  claim: {
    ...
    farcasterOnly: "Tämä jako on Farcaster-tileille — avaa se Farcasterissa liittyäksesi.",
  },
  login: {
