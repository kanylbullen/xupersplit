...
const nb: Dict = {
  ...
  passkeys: {
    title: "Passkeys",
    intro:
      "Med en passkey logger du inn med fingeravtrykk, ansikt eller skjermlås — uten å vente på en e-post. Du kan alltid logge inn med e-postkode i stedet.",
    loading: "Henter…",
    empty: "Du har ingen passkey ennå.",
    unnamed: "Passkey",
    added: "lagt til {date}",
  ...
  landing: {
    ...
    hero2Farcaster: "Gjør opp onchain.",
    subtitle:
    ...
    noLoginFarcaster: "Ingen innlogging nødvendig — eller logg inn med Farcaster.",
    step1Title: "1. Lag",
  ...
  new: {
    ...
    typeHeading: "Hva slags split?",
    typeSimple: "Enkel",
    typeSimpleDesc: "Ingen innlogging — bare navn og en lenke.",
    typeEmail: "E-post",
    typeEmailDesc: "Inviter hver person via e-post.",
    typeFarcaster: "Farcaster",
    typeFarcasterDesc: "Velg folk du følger på Farcaster.",
    signInRequired: "krever innlogging",
    back: "Tilbake",
    toHome: "Hjem",
    emailInviteHint: "Hver person inviteres via e-post og tar sin egen plass.",
