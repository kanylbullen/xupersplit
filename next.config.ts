...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      // auth.farcaster.xyz: Quick Auth client mints the FID token from there.
      "connect-src 'self' https://auth.farcaster.xyz https://*.supabase.co https://*.vercel-insights.com https://vitals.vercel-insights.com https://*.walletconnect.org https://*.walletconnect.com wss://*.walletconnect.org wss://*.walletconnect.com https://*.reown.com https://api.web3modal.org https://*.solana.com https://solana-rpc.publicnode.com" +
        supabaseConnectSrc(),
